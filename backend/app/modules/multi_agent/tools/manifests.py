...
CAPABILITY_MANIFESTS: dict[str, AgentCapabilityManifest] = {
    ...
    "capacity_booking_agent": AgentCapabilityManifest(
        ...
        version="v4.2",
        read_scopes=["routes", "shipment_volume", "carrier_schedules", "rate_cards", "capacity", "sla_requirements", "signals"],
    ...
    "carrier_negotiation_agent": AgentCapabilityManifest(
        ...
        can_execute=False,
        allowed_tools=["get_historical_rate_variance", "calculate_target_pricing", "draft_negotiation_proposal"],
    ),
    ...
    "documentation_agent": AgentCapabilityManifest(
        ...
        allowed_tools=["verify_commercial_invoice", "check_packing_list", "validate_customs_declarations"],
    ),
    "compliance_agent": AgentCapabilityManifest(
        ...
        domain_group="COMPLIANCE",
        version="v5.0",
        read_scopes=["supplier_registry", "blacklist", "certifications", "trade_rules", "route_sanctions"],
        propose_scopes=["compliance_verdict", "execution_block_notice"],
        simulate_scopes=[],
        can_execute=False,
        can_block_execution=True,  # HARD VETO AUTHORITY
        allowed_tools=["check_supplier_blacklist", "verify_trade_compliance", "validate_hazmat_certifications"],
    ),
    ...
    "audit_agent": AgentCapabilityManifest(
        ...
        simulate_scopes=[],
        can_execute=False,
        allowed_tools=["verify_merkle_dag", "validate_decision_evidence_tuple", "generate_audit_trail"],
    ),
    ...
    "load_planning_agent": AgentCapabilityManifest(
        ...
        version="v4.5",
        read_scopes=["order_volumes", "dimensions", "weights", "equipment_types", "carrier_capacities"],
        propose_scopes=["load_manifest", "cube_utilization_plan"],
        simulate_scopes=["load_stability_simulation"],
        can_execute=False,
        allowed_tools=["calculate_3d_cube_utilization", "optimize_axle_weights", "generate_load_manifest"],
    ),
    "route_optimization_agent": AgentCapabilityManifest(
        ...
        can_execute=False,
        allowed_tools=["compute_dijkstra_delay_cost", "query_gnn_corridor_risk", "simulate_corridor_delay"],
    ),
    "consolidation_agent": AgentCapabilityManifest(
        ...
        can_execute=False,
        allowed_tools=["find_coloading_clusters", "calculate_freight_savings", "generate_consolidation_manifest"],
    ),
    "network_rebalancing_agent": AgentCapabilityManifest(
        ...
        can_execute=False,
        allowed_tools=["calculate_hub_imbalance", "generate_rebalancing_transfer", "simulate_stock_exhaustion"],
    ),
    ...
    "supplier_discovery_agent": AgentCapabilityManifest(
        ...
        can_execute=False,
        allowed_tools=["query_gnn_supplier_similarity", "search_qualified_suppliers", "filter_by_region"],
    ),
    "supplier_evaluation_agent": AgentCapabilityManifest(
        ...
        simulate_scopes=[],
        can_execute=False,
        allowed_tools=["calculate_supplier_scorecard", "query_historical_otif", "evaluate_supplier_risk"],
    ),
    "strategic_sourcing_agent": AgentCapabilityManifest(
        ...
        domain_group="PROCUREMENT",
        version="v4.4",
        read_scopes=["sourcing_strategies", "volume_commitments", "split_sourcing_rules", "rate_tiers"],
        propose_scopes=["split_allocation_plan", "sourcing_strategy_recommendation"],
        simulate_scopes=["twin_sourcing_monte_carlo"],
        can_execute=False,
        allowed_tools=["calculate_split_sourcing_allocation", "evaluate_expedite_vs_switch", "simulate_sourcing_scenario"],
    ),
    ...
    "nexus_supervisor": AgentCapabilityManifest(
        ...
        can_execute=False,
        can_block_execution=True,
        allowed_tools=["decompose_operational_incident", "route_to_specialists", "synthesize_consensus", "dispatch_to_digital_twin"],
    ),
}
