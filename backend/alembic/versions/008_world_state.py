...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_world_state_events_workspace_id", "world_state_events", ["workspace_id"], unique=False
    )
    op.create_index(
        "ix_world_state_events_entity",
        "world_state_events",
        ["entity_type", "entity_id"],
        unique=False,
    )
    op.create_index(
        "ix_world_state_events_event_type", "world_state_events", ["event_type"], unique=False
    )
    op.create_index(
        "ix_world_state_events_occurred_at", "world_state_events", ["occurred_at"], unique=False
    )
    op.create_index(
        "ix_world_state_events_world_id", "world_state_events", ["world_id"], unique=False
    )
    ...
    op.create_index(
        "ix_world_snapshots_workspace_id", "world_snapshots", ["workspace_id"], unique=False
    )
    ...
    op.create_index(
        "ix_world_snapshots_state_hash", "world_snapshots", ["state_hash"], unique=False
    )
    ...
    op.create_index(
        "ix_world_versions_workspace_id", "world_versions", ["workspace_id"], unique=False
    )
    ...
    op.create_index(
        "ix_world_metadata_workspace_id", "world_metadata", ["workspace_id"], unique=False
    )
